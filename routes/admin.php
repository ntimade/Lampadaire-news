...
use App\Http\Controllers\Admin\UrgentNewsController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function(){
    ...
    /** Advertisement Route */
    Route::resource('advertisement', \App\Http\Controllers\Admin\AdvertisementController::class);

    /** Editorial watch (RSS collection) Route */
    Route::get('veille', [\App\Http\Controllers\Admin\CollectedArticleController::class, 'index'])->name('veille.index');
    Route::post('veille/collect-now', [\App\Http\Controllers\Admin\CollectedArticleController::class, 'collectNow'])->name('veille.collect-now');
    Route::post('veille/{collectedArticle}/convert', [\App\Http\Controllers\Admin\CollectedArticleController::class, 'convert'])->name('veille.convert');
    Route::post('veille/{collectedArticle}/dismiss', [\App\Http\Controllers\Admin\CollectedArticleController::class, 'dismiss'])->name('veille.dismiss');

    /** Urgent (breaking bar) Route */
    Route::get('urgent-news/toggle', [UrgentNewsController::class, 'toggle'])->name('urgent-news.toggle');
    Route::resource('urgent-news', UrgentNewsController::class);
