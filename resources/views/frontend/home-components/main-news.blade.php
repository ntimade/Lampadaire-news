                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="recent-grid">
                        @foreach ($recentNews->take(6) as $news)
                            <a href="{{ route('news-details', $news->slug) }}" class="recent-card">
                                <div class="recent-card__image">
                                    <img src="{{ asset($news->image) }}" alt="">
                                    <span class="recent-card__cat">{{ $news->category->name }}</span>
                                </div>
                                <div class="recent-card__body">
                                    <h5>{!! truncate($news->title, 70) !!}</h5>
                                    <div class="recent-card__meta">
                                        <span>{{ __('frontend.by') }} {{ $news->auther->name }}</span>
                                        <span>&middot;</span>
                    ...
                    <style>
                        .recent-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin-bottom: 10px; }
                        .recent-card { display: block; text-decoration: none; color: inherit; }
                        .recent-card__image { position: relative; border-radius: 12px; overflow: hidden; height: 150px; background: #eee; }
                        .recent-card__image img { width: 100%; height: 100%; object-fit: cover; display: block; transition: transform .4s ease; }
                        .recent-card:hover .recent-card__image img { transform: scale(1.06); }
                        .recent-card__cat {
                            position: absolute; left: 10px; bottom: 10px; background: var(--colorPrimary); color: #fff;
                            font-family: 'Poppins', sans-serif; font-size: 10px; font-weight: 700; text-transform: uppercase;
                            letter-spacing: .5px; padding: 5px 11px; border-radius: 30px;
                        }
                        .recent-card__body { padding-top: 12px; }
                        .recent-card__body h5 {
                            font-family: 'Playfair Display', Georgia, serif; font-weight: 700; font-size: 15px;
                            line-height: 1.3; margin: 0 0 8px; color: #1a1a1a; transition: color .15s;
                        }
                        .recent-card:hover .recent-card__body h5 { color: var(--colorPrimary); }
                        .recent-card__meta { font-family: 'Poppins', sans-serif; font-size: 11px; color: #888; display: flex; gap: 6px; }
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <x-ad-carousel placement="home_middle" />
                ...
                <div class="col-md-4">
                    <div class="sticky-top">
                        ...
                        <aside class="wrapper__list__article">
                            <x-ad-carousel placement="side_bar" :title="__('frontend.Advertise')" />
                        </aside>
