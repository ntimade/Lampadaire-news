<div class="card border border-primary">
    <div class="card-body">
        <form action="{{ route('admin.general-setting.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="control-label">Bandeau "Urgent"</div>
                <label class="custom-switch mt-2">
                    <input value="1" type="checkbox" name="breaking_bar_enabled" class="custom-switch-input" {{ ($settings['breaking_bar_enabled'] ?? '1') == '1' ? 'checked' : '' }}>
                    <span class="custom-switch-indicator"></span>
                </label>
                <small class="text-muted d-block">Affiche ou masque le bandeau défilant des actualités urgentes sur tout le site.</small>
            </div>
