                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                    <input value="1" type="checkbox" name="show_at_journal" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                </label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                    <input value="1" type="checkbox" name="is_journal_lead" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                </label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                    <input value="1" type="checkbox" name="post_to_facebook" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                </label>
