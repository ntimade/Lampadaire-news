<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right ml-auto">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <img alt="image" src="{{ !empty(auth()->guard('admin')->user()->image) ? asset(auth()->guard('admin')->user()->image) : asset('admin/assets/img/avatar/avatar-1.png') }}" class="rounded-circle mr-1">
