    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @if (canAccess(['news index']))
                <li class="dropdown {{ setSidebarActive(['admin.news.*', 'admin.pending.news', 'admin.veille.*']) }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @if (canAccess(['news all-access']))
                            <li class="{{ setSidebarActive(['admin.veille.*']) }}"><a class="nav-link"
                                    href="{{ route('admin.veille.index') }}">Veille éditoriale</a></li>
                        @endif
            ...
            @if (canAccess(['urgent news index']))
                <li class="{{ setSidebarActive(['admin.urgent-news.*']) }}"><a class="nav-link"
                        href="{{ route('admin.urgent-news.index') }}"><i class="fas fa-bolt"></i>
                        <span>Urgent</span></a></li>
            @endif
